use crate::{cart::SaveFile, cpu::Cpu, graphics, mmu::Memory, timer};
...
impl Emulator {
    pub fn new() -> Emulator {
        Emulator { mem: Memory::new(), cpu: Cpu::new(), cycles: 0 }
    }

    pub fn load_cart(&mut self, data: &[u8], save_file: Option<Box<dyn SaveFile>>) {
